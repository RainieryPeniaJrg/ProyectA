...
namespace BE_ProyectoA.Core.Domain.Entities.Coordinadores
{
    public sealed class SubCoordinadores : AggregateRoot
    {
        ...
        public SubCoordinadores(SubCoordinadoresId id, string nombre, string apellido, CantidadVotos cantidadVotos, NumeroTelefono numeroTelefono, Cedula cedula, bool activo, Direccion direccion)
        {
            Id = id;
            Nombre = nombre;
            Apellido = apellido;
        ...
        public SubCoordinadores(SubCoordinadoresId id, string nombre, string apellido, CantidadVotos cantidadVotos, NumeroTelefono numeroTelefono, Cedula cedula, bool activo, Direccion direccion, CoordinadoresGeneralesId coordinadorsGeneralesId, CoordinadoresGenerales coordinadores, ICollection<DirigentesMultiplicadores> dirigentesMultiplicadores, ICollection<Grupos> grupos)
        {
            Id = id;
            Nombre = nombre;
            Apellido = apellido;
        ...
        public SubCoordinadores(SubCoordinadoresId id, string nombre, string apellido, CantidadVotos cantidadVotos, NumeroTelefono numeroTelefono, Cedula cedula, bool activo, Direccion direccion, CoordinadoresGeneralesId coordinadorsGeneralesId, CoordinadoresGenerales coordinadores)
        {
            Id = id;
            Nombre = nombre;
            Apellido = apellido;
        ...
        public SubCoordinadores(SubCoordinadoresId id, string nombre, string apellido, CantidadVotos cantidadVotos, NumeroTelefono numeroTelefono, Cedula cedula, bool activo, Direccion direccion,CoordinadoresGenerales coordinadores)
        {
            Id = id;
            Nombre = nombre;
            Apellido = apellido;
